...
pygame.display.set_caption('Min Sudoku Hacker')
...
def raise_error_1():
	text1 = font1.render('FEL!', 1, (0, 0, 0))
	screen.blit(text1, (20, 570))
	
	
def raise_error_2():
	text1 = font1.render('Fel! ogiltlig valör', 1, (0, 0, 0))
	screen.blit(text1, (20, 570))
...
def instruction():
	text1 = font2.render(
		'Christophers Sudoku-lösare', 1, (0, 0, 0))
	text2 = font2.render(
		'SKRIV IN VALÖRER SEDAN TRYCK ENTER FÖR HACK', 1, (0, 0, 0))
	screen.blit(text1, (20, 520))
	screen.blit(text2, (20, 540))
	
	
def result():
	text1 = font1.render('KLAR - TRYCK R FÖR ÅTERSTÄLLNING', 1, (0, 0, 0))
	screen.blit(text1, (20, 570))
